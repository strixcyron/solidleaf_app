...
const List<LauncherRelease> launcherChangelog = [
  LauncherRelease(
    ...
    changes: [
      ...
      'Тема «Из баннера»: цвета интерфейса подстраиваются под '
          'текущую обложку в баннере (статичная, анимированная или своя).',
      'Устойчивее Shizuku на HyperOS: staging на /sdcard → copyFile '
          '(как ZArchiver), soft probe, daemon UserService, toybox cp.',
